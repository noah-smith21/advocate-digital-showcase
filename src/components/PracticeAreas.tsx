...
const practices = [
  {
    ...
    bgImage: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
  },
  {
    ...
    bgImage: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
  },
  {
    ...
    bgImage: "https://images.unsplash.com/photo-1589578527966-fdac0f44566c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
  },
  {
    title: "Family Law",
    description: "Compassionate guidance through divorce, child custody, support matters, and other family-related legal concerns.",
    bgImage: "https://images.unsplash.com/photo-1591115765373-5207764f72e7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
  },
  {
    title: "Personal Injury",
    description: "Dedicated advocacy for injury victims seeking fair compensation after accidents caused by negligence.",
    bgImage: "https://images.unsplash.com/photo-1584515933487-779824d29309?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
  },
  {
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {practices.map((practice, index) => (
            <div 
              key={practice.title} 
              className={`opacity-0 animate-fade-in animate-delay-${(index % 3) * 100 + 200} relative group`}
              onMouseEnter={() => setHoveredIndex(index)}
              onMouseLeave={() => setHoveredIndex(null)}
            >
              <div 
                className="h-72 rounded-lg overflow-hidden relative"
                style={{ 
                  backgroundImage: `url(${practice.bgImage})`,
                  backgroundSize: 'cover',
                  backgroundPosition: 'center',
                  transition: 'all 0.3s ease-in-out',
                }}
              >
                <div className={`absolute inset-0 bg-gradient-to-t from-law-navy/90 to-transparent p-6 flex flex-col justify-end transition-all duration-300 ${hoveredIndex === index ? 'from-law-navy/95' : 'from-law-navy/80'}`}>
                  <h3 className="text-xl font-serif font-bold text-white mb-2">{practice.title}</h3>
                  <p className={`text-white/90 transition-all duration-300 ${hoveredIndex === index ? 'opacity-100 max-h-40' : 'opacity-0 max-h-0 overflow-hidden'}`}>
